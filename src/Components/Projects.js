...
function Projects() {
 ...
 <div className='grid gap-5 grid-cols-2 grid-rows-2 pl-4 pb-5  justify-items-center max-sm:pr-4 max-sm:mt-8 ' >
  ...
  <a className='transition duration-500 hover:scale-110 ' href='https://e-commerce-product-two.vercel.app/' target="_blank" rel="noreferrer">
  <p className='flex justify-center text-xl max-sm:text-lg'>   E-commerce</p> 
   ...
   <a className=' flex justify-center pt-2 ' href='https://github.com/bugrasarilan/e-commerce-product' target="_blank" rel="noreferrer">
  ...
  <a className='transition duration-500 hover:scale-110 ' href='https://weather-forecast-u9xl.vercel.app/' target="_blank" rel="noreferrer">
  ...
  <a className=' flex justify-center pt-2 ' href='https://github.com/bugrasarilan/Weather-Forecast' target="_blank" rel="noreferrer">
      <button className='rounded-lg transition ease-in-out delay-150 text-xl max-sm:text-[16px] hover:-translate-y-1  hover:scale-110 hover:bg-slate-300 duration-300 transform ' >Show me source code</button> 
      </a>
</a>

  <a className='transition duration-500 hover:scale-110 ' href='https://todo-list-smoky-seven.vercel.app/' target="_blank" rel="noreferrer"> 
 ...
 <a className=' flex justify-center pt-2 ' href='https://github.com/bugrasarilan/todo-list' target="_blank" rel="noreferrer">
 <button className='rounded-lg transition ease-in-out delay-150 text-xl max-sm:text-[16px] hover:-translate-y-1 hover:scale-110 hover:bg-slate-300 duration-300 transform ' >Show me source code</button> 
  </a>
    </a>

  <a className='transition duration-500 hover:scale-110 ' href='https://calculator-snowy-three.vercel.app' target="_blank" rel="noreferrer"> 
 ...
 <a className='flex justify-center pt-2 ' href='https://github.com/bugrasarilan/calculator.' target="_blank" rel="noreferrer">
 <button className='rounded-lg transition ease-in-out delay-150 text-xl max-sm:text-[16px] hover:-translate-y-1 hover:scale-110 hover:bg-slate-300 duration-300 transform  ' >Show me source code</button> 
     </a>
      </a> 
      </div>
