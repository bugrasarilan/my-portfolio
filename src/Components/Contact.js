...
function Contact() {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm("gmail", "template_mbjt9wa", e.target, KEY).then(
      (result) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:ml-4">
              ...
              <div className="social-icons text-white flex flex-row gap-5 ml-5 animate-bounce">
                <a
                  href="https://www.linkedin.com/in/bu%C4%9Fra-sar%C4%B1lan-390343183/"
                  target="_blank" rel="noreferrer"
                >
                  <BsLinkedin />
                </a>
                <a href="https://github.com/bugrasarilan" target="_blank" rel="noreferrer">
                  <BsGithub />
                </a>
                <a href="https://medium.com/@bugrasarilan" target="_blank" rel="noreferrer">
                  <AiFillMediumCircle />
                </a>
                <a
                  href="https://www.instagram.com/bugrasarlan/"
                  target="_blank" rel="noreferrer"
                >
                  <BsInstagram />
                </a>
            ...
            >
              ...
              {errors.name && touched.name && (
                <div className="text-blue-700 font-bold ml-4  ">
                  {errors.name}
                </div>
              )}
